...
const ServicesSection = () => {
  const services = [
    ...
    },
    {
      ...
      description: "Mining operations expertise from feasibility to execution. Specializing in material handling systems, process optimization, and operational efficiency for mining projects.",
      features: ["Feasibility & Due Diligence Studies", "CAPEX/OPEX Analysis", "Material Handling System Design", "Process Flow Development"],
      lead: "Noah Bain"
    }
  ];
  ...
  return (
    <Section id="services">
      <Container>
        <SectionHeader
          title="Our Services"
          subtitle="Complete exploration to operations support: AI targeting, custom software, and mining engineering consulting"
        />
